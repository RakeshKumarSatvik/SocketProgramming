...
#define MYPORT "24251"	// the port users will be connecting to
...
int main(int argc)
{
	...
	/*Code for Phase 2*/
	{
		...
		printf("The Server D has received the network topology from the Client with UDP port number %s and IP address %s "
